...
public class Test extends javax.swing.JFrame {
    ...
    private void btnEntregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEntregarActionPerformed
        if (!finishAnswers()) {
            int dialogResult = JOptionPane.showConfirmDialog(this, "Você deseja entregar a prova sem responder todas as questões?", "Aviso", JOptionPane.YES_NO_OPTION);
    ...
    private void btnRefazerProvaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRefazerProvaActionPerformed
        if (!delivered) {
            int dialogResult = JOptionPane.showConfirmDialog(this, "Você deseja refazer a prova sem entregar a atual?", "Aviso", JOptionPane.YES_NO_OPTION);
    ...
    private void deliveryTest() {
        ...
        if (corrects > 21) {
            JOptionPane.showMessageDialog(this, new JLabel("<html><body><h1 style='color: green;'>Passou!</h1><br>Você acertou " + corrects + " de 30.</body></html>", JLabel.CENTER), "Resultado", JOptionPane.PLAIN_MESSAGE);
        } else {
            JOptionPane.showMessageDialog(this, new JLabel("<html><body><h1 style='color: red;'>Não Passou.</h1><br>Você acertou " + corrects + " de 30.</body></html>", JLabel.CENTER), "Resultado", JOptionPane.PLAIN_MESSAGE);
        }
    }
